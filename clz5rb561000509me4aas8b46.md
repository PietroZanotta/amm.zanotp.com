...
$$C\ket\psi n\ket 0 = \ket \phi_n= \sum{i<K} \sqrt{p_i}\ket i_n\otimes \ket 0 + \sum_{i\geq K} \sqrt{p_i}\ket i_n \otimes \ket 1$$
...
$$\begin{align} R\ket{\phi}n\ket{0} &= \sum{i<K} \sqrt{p_i} \ket{i}n \otimes \ket{0} \otimes \left( \cos[g_0]\ket{0} + \sin[g_0]\ket{1} \right) \notag \\ &\quad + \sum{i \geq K} \sqrt{p_i} \ket{i}_n \otimes \ket{0} \otimes \left( \cos[g_0 + g(i)]\ket{0} + \sin[g_0 + g(i)]\ket{1} \right) \end{align}$$
